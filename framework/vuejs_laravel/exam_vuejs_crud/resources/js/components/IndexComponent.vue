<template>
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <router-link :to="{name:'create'}" class="btn btn-primary">Create Posts</router-link>>
            </div>
        </div></br>
        ...
        methods:{
            deletePost(id) {
                ...
                this.axios.delete(uri).then((response)=> {
                    this.post.splice(this.posts.indexOf(id),1); // ở đây có nghĩa là ta sẽ lấy từ phần tử thứ i và xóa 1 phần tử của mảng
                });
            }
        }
